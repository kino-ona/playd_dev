...
(function($) {
    $.imageArea = function(parent, id) {
        ...
        var options = parent.options,
            ...
            startSelection  = function (event) {
                ...
                area.fi_idx = uploadArray[frame_seek];
        ...
        return {
            ...
            set: function (dimensions, silent) {
                ...
                if (annotation_text[area.annotation] != undefined) {
                    $("#background_area_" + area.id).css({
                        'backgroundColor': annotation_text[area.annotation][0].color,
                        'opacity':'0.4',
                        'margin': '-1px 0 0 -1px',
                        'border': '2px solid ' + annotation_text[area.annotation][0].color
                    });
                }
    ...
    $.fn.selectAreas = function(customOptions) {
        if ( $.imageSelectAreas.prototype[customOptions] ) { // Method call
            ...
            if(frame_first==true){
                imageArray[frame_seek].onload = function(){
                    $.selectAreas(imageArray[frame_seek], customOptions);
                };
                frame_first = false;
            } else {
                $.selectAreas(imageArray[frame_seek], customOptions);
