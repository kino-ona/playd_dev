...
// 아이디 정보
if($cmpny_nm && $email_adres) {
    $sql = "select a.emplyr_id
    ...
    $row = sql_fetch($sql);
    $res = ($row) ? $row['emplyr_id'] : "등록된 정보가 없습니다.";
}
		...
		<div id="member_container">
			<div class="inner">
				<div class="sect member_tab">
					<div class="head">
						<ul>
							<li class="cur"><a href="find_id">아이디 찾기</a></li>
							<li><a href="find_pw">비밀번호 찾기</a></li>
						</ul>
					</div>
					<div class="member_wrap find_id">
