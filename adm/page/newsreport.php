...
function excel_download() {
    var f = document.f;
    f.action = '<?php echo P1_PAGE_URL ?>/report_excel_download.php';
    f.submit();
}
</script>
...
<form name="multi_del_frm" id="multi_del_frm" action="<?php echo P1_PAGE_URL ?>/newsreport_update.php" onsubmit="return multi_del();" method="post">
