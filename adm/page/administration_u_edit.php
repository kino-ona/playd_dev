...
<form name="frm" method="post" action="<?php echo P1_PAGE_URL ?>/administration_u_insert.php" onsubmit="return send();" enctype="multipart/form-data">
<input type="hidden" name="m" value="<?php echo $m ?>">
<?php if ($user['M_SEQ']) { ?>
<input type="hidden" name="seq" value="<?=$user['M_SEQ']?>">
<?php } ?>
<input type="hidden" name="m_auth_tp" value="9"/>
<input type="hidden" name="g_seq" value="<?=$user['G_SEQ']?>"/>
    ...
    <legend class="hid1">관리자 등록 및 수정</legend>
        <table class="colTable">
            ...
            <tr>
                ...
                <td>
                    <label for="g_seq">
                        <select name="g_seq22" id="g_seq" disabled>
