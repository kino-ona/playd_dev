...
<form name="frm" method="post" action="<?php echo P1_PAGE_URL ?>/pl_incident_insert.php" onsubmit="return send();" enctype="multipart/form-data">
...
<?php } ?>
    ...
    <legend class="hid1">입사지원관리 및 수정</legend>
        ...
        <div class="bothButton">
            <div class="fl">
                <button class="btn btn-inverse" type="button" onclick="fnGoView('<?php echo P1_PAGE_URL ?>/pl_incident.php');">목록</button>
            </div>
            <div class="fr">
                <?php if ($m == "u") { ?>
                <input type="submit" class="btn btn-primary" value="수정">
                <button class="btn btn-inverse" type="button" onclick="deletes('<?php echo P1_PAGE_URL ?>/pl_incident_del.php');">삭제</button>
                <?php } ?>
                <?php if ($m == "") { ?>
