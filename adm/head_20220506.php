        ...
        <div id="container">
            ...
            <div id="snb">
                <ul>
                    ...
                    <li class="da<?=($p1['subtitle'] == "게시판 관리") ? " on" : ""?>" id="m2"><a href="#">게시판 관리</a>
                        <ul class="sub">
                    ...
                    <li class="db<?=($p1['subtitle'] == "문의관리") ? " on" : ""?>" id="m2"><a href="#">문의관리</a>
                        <ul class="sub">
                            ...
                            <?php if (auth_check_no("bd", "2")) { ?><li id="m3-4"><a href="<?php echo P1_PAGE_URL ?>/qna.php?bc_code=nsmcommerce"<?=($p1['title'] == "글로벌커머스") ? " class='on'" : ""?>>글로벌커머스</a></li><?php } ?>
                        </ul>
                    </li>
                    <?php } ?>
                    <?php if (auth_check_no("c", "1")) { ?>
                    <li class="dc<?=($p1['subtitle'] == "채용관리(PLAYD)") ? " on" : ""?>" id="m3"><a href="#">입사지원관리(PLAYD)</a>
                        <ul class="sub">
...
?>
                    ...
                    <li class="dd<?=($p1['subtitle'] == "채용관리(MABLE)") ? " on" : ""?>" id="m4"><a href="#">채용관리(MABLE)</a>
                        <ul class="sub">
...
?>
                    ...
                    <?php } ?>
					<?php if (auth_check_no("a", "1")) { ?>
                    <li class="db<?=($p1['subtitle'] == "PDF게시판") ? " on" : ""?>" id="m6"><a href="#">PDF게시판</a>
                        <ul class="sub">
                            <?php if (auth_check_no("aa", "2")) { ?><li id="m6-1"><a href="<?php echo P1_PAGE_URL ?>/pdf_category_list.php"<?=($p1['title'] == "PDF카테고리관리") ? " class='on'" : ""?>>PDF카테고리관리</a></li><?php } ?>
                            <?php if (auth_check_no("ab", "2")) { ?><li id="m6-2"><a href="<?php echo P1_PAGE_URL ?>/pdf_list.php"<?=($p1['title'] == "PDF게시판") ? " class='on'" : ""?>>PDF게시판</a></li><?php } ?>
                        </ul>
                    </li>
                    <?php } ?>
                    ...
                    <li class="df" id="m6">
                        <a href="<?php echo P1_PAGE_URL ?>/file_upload.php">파일 업로드</a>
                    </li>
                    <?php } ?>
					<!-- <li id="m7"> -->
