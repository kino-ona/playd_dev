...
CREATE TABLE IF NOT EXISTS `T_ASK` (
  ...
  `A_TEL` varchar(500) DEFAULT NULL,
  `A_MAIL` varchar(500) DEFAULT NULL,
  `A_URL` varchar(500) DEFAULT NULL,
  `A_ID` varchar(100) DEFAULT NULL,
  `A_TYPE` varchar(500) DEFAULT NULL,
  `A_TYPE_GUBUN1` varchar(200) DEFAULT NULL,
  `A_TYPE_GUBUN2` varchar(500) DEFAULT NULL,
  `A_TYPE_GUBUN3` varchar(500) DEFAULT NULL,
  `A_DATE` datetime DEFAULT NULL,
  `A_RE_YN` char(1) DEFAULT 'N',
  `A_CORP_NAME` varchar(500) DEFAULT NULL,
  `A_JIK` varchar(200) DEFAULT NULL,
  `A_PROJECT_DT` varchar(200) DEFAULT NULL,
  `A_CONNET` varchar(255) DEFAULT NULL,
  `A_MARKET_YN` char(1) DEFAULT 'N',
  `A_MARKET2_YN` char(1) DEFAULT 'N',
  `A_FILE1` varchar(500) DEFAULT NULL,
  `A_SYSFILE1` varchar(500) DEFAULT NULL,
  `A_ETC_MEMO` mediumtext,
  `A_RCONT` mediumtext,
